            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
                    ...
                    <div className="flex space-x-4">
                        <a
                            href="linkedin.com/in/chukwuebuka-chizoba-7a1354126"
                            aria-label="Linkedin"
                        ...
                        <a
                            href="https://flowcv.me/chizobaebuka1"
                        ...
                        <a
                            href="https://github.com/chizobaebuka"
                            aria-label="Github"
                            className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white"
                        >
                ...
                <div className="mt-8 text-center md:flex md:justify-between md:items-center">
                    <p className="text-gray-600 dark:text-gray-400">
                        &copy; 2024 Martins Chizoba. All rights reserved.
                    </p>
