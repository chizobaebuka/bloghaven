    ...
    return (
        <section className="py-12">
            <article className="max-w-4xl mx-auto p-6 shadow-md border rounded-lg">
                    ...
                    news?.imageUrl && (
                        <div>
                            <Image
                                ...
                                width={800}
                                height={450}
                                className="rounded-md onject-cover"
                            />
                        </div>
                    )
                }
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquid dolorum neque quam recusandae asperiores sint, consequuntur rem eius fuga deleniti tempore totam enim eum impedit quia dicta vero velit qui! Vel modi expedita, delectus totam dolores, esse illo at ex fugiat illum iure dolorem repellat?</p>
            </article>
        </section>
    )
}
